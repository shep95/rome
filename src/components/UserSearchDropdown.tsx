            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full mt-1 p-3 bg-background/50 border border-border rounded-lg resize-none text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none"
                  rows={3}
                />
              </div>
