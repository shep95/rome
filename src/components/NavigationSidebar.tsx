    ...
    <div className="h-full flex flex-col p-4 lg:p-6">
      ...
      <ScrollArea className="flex-1 -mx-2">
        <nav className="space-y-2 lg:space-y-3 px-2">
          ...
          <Button
            onClick={() => {
              onSectionChange('location-osint');
              setIsMobileSidebarOpen(false);
            }}
            variant="ghost"
            className={`w-full h-10 lg:h-12 justify-start px-3 lg:px-4 transition-all duration-300 ${
          ...
          >
            <MapPin className="w-4 h-4 lg:w-5 lg:h-5 mr-2 lg:mr-3" />
            <span className="text-sm font-medium">Location OSINT</span>
          </Button>
      ...
      <Dialog open={isCryptoModalOpen} onOpenChange={setIsCryptoModalOpen}>
        <DialogContent className="sm:max-w-md bg-background/10 backdrop-blur-xl border border-border/20">
          <div className="relative p-8">
            ...
            <div className="relative z-10 text-center space-y-6">
              <div className="w-16 h-16 mx-auto rounded-2xl flex items-center justify-center">
                <img src={aureumLogo} alt="Zorak Logo" className="w-16 h-16 object-contain" />
              </div>
              
                <div className="space-y-4">
                <h3 className="text-2xl font-bold text-foreground">Zorak</h3>
